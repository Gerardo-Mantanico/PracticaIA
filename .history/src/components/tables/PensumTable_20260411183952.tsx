...
export default function PensumTable() {
  ...
  useEffect(() => {
    ...
    if (isDetailOpen && selectedPensum) {
      loadPensumCourses();
    }
                ...
                <div className="space-y-4 p-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      title="Ver pensum"
                      aria-label="Ver pensum"
                      className="inline-flex items-center rounded-xl bg-brand-500 px-3.5 py-2 text-white transition hover:bg-brand-600"
                    >
                    ...
                    <button
                      ...
                      title="Editar pensum"
                      aria-label="Editar pensum"
                      className="inline-flex items-center rounded-xl border border-gray-200 px-3.5 py-2 text-gray-700 transition hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
                    >
                    ...
                    <button
                      ...
                      aria-label="Eliminar pensum"
                      className="inline-flex items-center rounded-xl border border-red-200 px-3.5 py-2 text-red-600 transition hover:bg-red-50 dark:border-red-900/40 dark:text-red-300 dark:hover:bg-red-900/20"
                    >
