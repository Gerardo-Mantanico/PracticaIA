        ...
        <div className="mt-6 space-y-5">
            ...
            >
              <div className="no-scrollbar relative w-full max-w-2xl overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8">
                ...
                <div className="mt-4 flex items-center justify-end gap-2 pr-12">
                  {!isEditingCourseInModal && (
                    <button
                      type="button"
                      ...
                      className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-300 text-gray-600 transition hover:bg-gray-100 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
                    >
                  ...
                  <button
                    ...
                    className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-red-200 text-red-600 transition hover:bg-red-50 dark:border-red-900/40 dark:text-red-400 dark:hover:bg-red-900/10"
                  >
                  ...
                  <div className="mt-5 space-y-4 rounded-2xl border border-gray-200 bg-gray-50/70 p-4 dark:border-gray-800 dark:bg-gray-800/30">
                    ...
                    {showAddPrerequisiteForm && (
                      <form className="grid grid-cols-1 gap-3 rounded-xl border border-gray-200 bg-white p-3 dark:border-gray-700 dark:bg-gray-900/60" onSubmit={handleCreateCoursePrerequisite}>
                        ...
                        <code className="block rounded-md bg-gray-100 px-2 py-1 text-xs text-gray-700 dark:bg-gray-800 dark:text-gray-200">
                          {`{"pensumCourseId": ${Number(selectedCourseAssignment.id ?? 0)}, "prerequisiteId": ${newPrerequisiteId || 0}}`}
                        </code>
